...
class ScientificViewHolder(itemView: View, private val format: String, private val hideKeyboardCallback: () -> Unit): BaseViewHolder(itemView, hideKeyboardCallback) {
        ...
        input.onFocusChangeListener = View.OnFocusChangeListener { _, hasFocus ->
            ...
            if (hasFocus && (numericValue != null)) {
                ...
                numericValue?.let {
                    ...
                    input.setText(numFormat.format(numericValue))
                }
            }
        }
